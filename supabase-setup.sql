...
-- 출결 테이블 (신규 설치용)
-- status: O=출석, A=결석, U=미확인 (HRD 2026 기준: 지각 폐지)
...
-- 3. 기본 강의실 데이터 등록
-- ==========================================
-- floor 컬럼이 없는 기존 테이블에 컬럼 추가 (이미 있으면 무시)
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS floor INTEGER DEFAULT 0;

INSERT INTO rooms (floor, name, addr, capacity, equip) VALUES
  -- 1층
  (1, '드림스튜디오',      '1층',       2,  '개인 작업 공간 (1/2인실)'),
  (1, '어울림홀',           '1층',       25, '빔프로젝터·강의대·음향'),
  (1, '차오름홀',           '1층',       50, '무대·음향·빔프로젝터'),
  (1, 'IT교육장 205호',     '1층 205호', 30, 'PC 30대·빔프로젝터'),
  (1, 'IT교육장 206호',     '1층 206호', 30, 'PC 30대·빔프로젝터'),
  -- 2층
  (2, 'IT교육장 209호',     '2층 209호', 30, 'PC 30대·빔프로젝터'),
  (2, 'IT교육장 210호',     '2층 210호', 30, 'PC 30대·빔프로젝터'),
  (2, '일반교육장 201호',   '2층',       25, '빔프로젝터·화이트보드'),
  (2, '일반교육장 202호',   '2층',       25, '빔프로젝터·화이트보드'),
  (2, '일반교육장 203호',   '2층',       25, '빔프로젝터·화이트보드'),
  (2, '일반교육장 204호',   '2층',       25, '빔프로젝터·화이트보드'),
  (2, '집단상담실',         '2층',       10, '원형 테이블·의자'),
  -- 3층
  (3, '일반교육장 301호',   '3층 301호', 25, '빔프로젝터·화이트보드'),
  (3, '일반교육장 305호',   '3층 305호', 25, '빔프로젝터·화이트보드'),
  (3, '일반교육장 306호',   '3층 306호', 25, '빔프로젝터·화이트보드'),
  (3, '분임토의실',         '3층',       15, '원형 테이블·화이트보드')
ON CONFLICT DO NOTHING;
...
BEGIN
  ...
  -- 학생이 실제 출석한 날 수
  -- HRD 2026 기준: 지각(L) 폐지 → 출석(O)만 출석일로 집계; 결석(A)·미확인(U)은 미출석 처리
